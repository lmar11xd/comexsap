...
import { LISTAR_PACKINGLIST_CARGASUELTA } from 'src/app/shared/breadcrumb/breadcrumb';
...
export class ListarPackingListCargaSueltaComponent implements OnInit {
  ...
  inicializarBreadcrumb(){
    this.breadcrumb2Service.addBreadcrumbs(LISTAR_PACKINGLIST_CARGASUELTA);
  }
  ...
  irAEditar(packinglist: PackingList) {
    ...
    this.router.navigate(['/exportaciones/packinglist/cargasuelta/editar', packinglist.id]);
  }
