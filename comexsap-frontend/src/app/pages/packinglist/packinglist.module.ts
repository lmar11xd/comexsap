...
import { PackingListRoutes } from './packinglist.routing';
...
@NgModule({
    declarations: [
        ListarPackingListContenedorComponent,
        EditarPackingListContenedorComponent,
        ListarPackingListCargaSueltaComponent,
        EditarPackingListCargaSueltaComponent,
        ListarPackingListAereoComponent,
        EditarPackingListAereoComponent
    ],
    providers: [
        DatePipe,
        MessageService,
    ...
    imports: [
        CommonModule,
        RouterModule.forChild(PackingListRoutes),
        FormsModule,
        ReactiveFormsModule,
        NgbModule,
        NotifierModule,
