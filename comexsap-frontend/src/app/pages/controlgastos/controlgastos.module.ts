...
import { ControlGastosRoutes } from './controlgastos.routing';
...
@NgModule({
  imports: [
    CommonModule,
    RouterModule.forChild(ControlGastosRoutes),
    FormsModule,
    ReactiveFormsModule,
    NgbModule,
    NotifierModule,
  ...
  declarations: [
    ListarControlGastosContenedoresComponent,
    RegistrarControlGastosContenedoresComponent,
    ListarControlGastosCargaSueltaComponent,
    RegistrarControlGastosCargaSueltaComponent
  ],
  providers: [
    DatePipe,
    MessageService,
