...
import { EDITAR_DOCUMENTOMARITIMO_CONTENEDORES, LISTAR_DOCUMENTOMARITIMO_CONTENEDORES } from 'src/app/shared/breadcrumb/breadcrumb';
...
export class EditarContenedorComponent implements OnInit {
  ...
  inicializarBreadcrumb(id: string){
    EDITAR_DOCUMENTOMARITIMO_CONTENEDORES[0].url = EDITAR_DOCUMENTOMARITIMO_CONTENEDORES[0].url.replace(':id', id);
    let BREADCRUMBS: MenuItem[] = [];
    BREADCRUMBS = BREADCRUMBS.concat(LISTAR_DOCUMENTOMARITIMO_CONTENEDORES);
    BREADCRUMBS = BREADCRUMBS.concat(EDITAR_DOCUMENTOMARITIMO_CONTENEDORES);
